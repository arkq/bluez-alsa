...
#define BLUEALSA_TRANSPORT_TYPE_ASHA        "ASHA"
#define BLUEALSA_TRANSPORT_TYPE_ASHA_SOURCE BLUEALSA_TRANSPORT_TYPE_ASHA "-source"
#define BLUEALSA_TRANSPORT_TYPE_ASHA_SINK   BLUEALSA_TRANSPORT_TYPE_ASHA "-sink"
