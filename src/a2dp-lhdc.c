...
void *a2dp_lhdc_enc_thread(struct ba_transport_pcm *t_pcm) {
	...
	case A2DP_CODEC_VENDOR_ID(LHDC_V2_VENDOR_ID, LHDC_V2_CODEC_ID):
		lhdc_max_bitrate_index = get_lhdc_max_bitrate(t->a2dp.configuration.lhdc_v2.max_bitrate);
		lhdc_bit_depth = t->a2dp.configuration.lhdc_v2.bit_depth == LHDC_BIT_DEPTH_16 ? 16 : 24;
		lhdc_dual_channel = t->a2dp.configuration.lhdc_v2.ch_split_mode > LHDC_CH_SPLIT_MODE_NONE;
		lhdc_interval = t->a2dp.configuration.lhdc_v2.low_latency ? 10 : 20;
		break;
...
void *a2dp_lhdc_dec_thread(struct ba_transport_pcm *t_pcm) {
	...
	case A2DP_CODEC_VENDOR_ID(LHDC_V2_VENDOR_ID, LHDC_V2_CODEC_ID):
		dec_config.version = VERSION_2;
		dec_config.bits_depth = t->a2dp.configuration.lhdc_v2.bit_depth == LHDC_BIT_DEPTH_16 ? 16 : 24;
		break;
	case A2DP_CODEC_VENDOR_ID(LHDC_V3_VENDOR_ID, LHDC_V3_CODEC_ID):
