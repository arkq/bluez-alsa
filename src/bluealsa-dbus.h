...
#define BA_DBUS_TRANSPORT_UPDATE_FORMAT   (1 << 0)
#define BA_DBUS_TRANSPORT_UPDATE_CHANNELS (1 << 1)
#define BA_DBUS_TRANSPORT_UPDATE_SAMPLING (1 << 2)
#define BA_DBUS_TRANSPORT_UPDATE_CODEC    (1 << 3)
#define BA_DBUS_TRANSPORT_UPDATE_DELAY    (1 << 4)
#define BA_DBUS_TRANSPORT_UPDATE_VOLUME   (1 << 5)
#define BA_DBUS_TRANSPORT_UPDATE_BATTERY  (1 << 6)
