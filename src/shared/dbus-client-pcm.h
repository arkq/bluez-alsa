...
#define BA_PCM_TRANSPORT_ASHA_SOURCE (1 << 2)
#define BA_PCM_TRANSPORT_ASHA_SINK   (2 << 2)
#define BA_PCM_TRANSPORT_HFP_AG      (1 << 4)
#define BA_PCM_TRANSPORT_HFP_HF      (2 << 4)
#define BA_PCM_TRANSPORT_HSP_AG      (1 << 6)
#define BA_PCM_TRANSPORT_HSP_HS      (2 << 6)

#define BA_PCM_TRANSPORT_MASK_A2DP \
	(BA_PCM_TRANSPORT_A2DP_SOURCE | BA_PCM_TRANSPORT_A2DP_SINK)
#define BA_PCM_TRANSPORT_MASK_ASHA \
